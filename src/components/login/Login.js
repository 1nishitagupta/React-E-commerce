  ...
  return (
   ...
   <form>
      ...
      <div className="email-login">
         ...
         <input type="text" placeholder="Enter Email" name="email" onChange={handleDetail} required />
         <label htmlFor="psw"><b>Password</b></label>
         <input type="password" placeholder="Enter Password" name="password" onChange={handleDetail} required />
      </div>
      <button className="cta-btn" onClick={(e)=> {e.preventDefault(); matchDetails(loggedInDetail);}}>Log In</button>
   </form>
</div>
  )
}
